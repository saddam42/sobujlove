...
#DON'T FORGET TO GIVE CREDIT TO  SK SOBUJ
...
try:
	...
	os.system("python2 sobujlove.py")
...
def main():
	...
	print("\t\033[93;1m      SK SOBUJ\x1b[0m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[SK-CP] "+uid+" | "+pass3+"\033[0;97m")
